      ...
      <>
        <div className="lg:my-16">
          ...
          <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-10 lg:py-20 gap-6">
            <div>
              <div
                className="group w-full bg-white relative flex flex-col items-center hover:bg-[#ea001e] cursor-pointer shadow-md md:p-12 p-6"
              >
                <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                  ...
                  Carzane is a game-changer for car buyers. With a vast selection of vehicles from leading brands and user-friendly tools, finding the perfect car has never been easier. The sites informative content and expert insights make it a go-to destination for anyone looking to purchase a vehicle. Carzane truly streamlines the car-buying process, making it a top choice for automotive enthusiasts.
                  </p>
                </div>
              ...
              <div className="flex flex-col items-center justify-center mt-10 rounded-full">
                <img
                  ...
                  className="w-12 h-12"
                />
                <p className="text-base font-semibold leading-4 my-2 text-[#ea001e]">
                  John Deo
                </p>
              </div>
            </div>
